  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-2">
        <img className="rounded-full" width="32" height="32" alt="" src={ReviewCard.img} />
        <div className="flex flex-col">
          <figcaption className="text-sm font-medium dark:text-white">
            {name}
          </figcaption>
          <p className="text-xs font-medium dark:text-white/40">{ReviewCard.username}</p>
        </div>
      </div>
      <blockquote className="mt-2 text-sm">{ReviewCard.body}</blockquote>
    </figure>
  );
};
